...
like this:
\begin{equation*}
x + \frac{1}{4}x^2 + \frac{1}{8}x^3 + \frac{1}{16}x^4 + \ldots
\end{equation*}
This is an example of an \emph{infinite series}; we don't consider
them polynomials. Infinite series are interesting and useful, but we
will put off talking about them until later in the course.

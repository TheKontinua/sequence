...
\section{Cognitive Bias: Fundamental Attribution Error}

Our brains were designed over millions of years by the evolutionary
process. The resulting mind is an amazingly powerful tool, but it is
...
\newterm{Fundamental Attribution Error} is your tendency to attribute
...
for class ?''  You are likely to say something like ``Larry is lazy
and disorganized.''
...
The fix? Cut people some slack. You probably don't know the whole
story, so assume that their character is as strong as yours.

Maybe you also need to hold yourself to a higher standard? Do you find

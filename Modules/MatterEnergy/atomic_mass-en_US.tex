...
We know how many protons an atom by what element it is. Every helium
atom, for example, has 2 protons. What about the number neutrons?
...
A hydrogen atom nearly always has just 1 proton. A helium atom nearly
always has 2 protons and 2 neutrons. So, if you have a 100 hydrogen
atoms and 100 helium atoms, the helium will have about 4 times more
mass than the hydrogen. We say ``Hydrogen is about 1 atomic mass unit,
and helium-4 is about 4 atomic mass units.''\index{atomic mass unit}

What, precisely, is an atomic mass unit? It is defined to be 1/12 of
...
about 10 atomic mass units. The atomic mass of boron is the average
...
atomic mass units equals 1 gram. Scientists use this number so much
that they gave it a name: \textit{the Avogadro constant} or
\textit{Avogadro's number}.\index{Avogadro's number}

If you have 12 doughnuts, you have a dozen doughnuts.  If you have
...
atomic mass units. $Cl$ is 35.453 atomic mass units.  One atom of
...
If I need 200 grams of water, how much many grams of methane do I need
to burn?
...
when it was created in a lab. It is highly radioactive: a copernicium
...
Bismuth, with an atomic number of 83, is \textit{almost} stable. Most

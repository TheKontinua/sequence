...
temperature. (We call this ``thermal equiliberium.'')\index{thermal equilibrium}
...
very difficult to guess the specific heat of substance. We determine
...
\begin{Exercise}[title={Cooling Your Coffee}, label=cool_coffee]
  ...
  You need to start chugging your coffee in three minutes, and you want it as cool as possible at that time. When should you put the milk in?

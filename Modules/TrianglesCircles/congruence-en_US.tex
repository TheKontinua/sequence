...
These triangles are not congruent, but they are \emph{similar}. That
is, they have the same shape, but are not necessarily the same
scale.

If you know two angles, you can calculate the third. So it makes sense
...
is equal in length, they must be the same scale -- so they are
...
I think it will help to see how this happens if I lay one triangle on top of the other:

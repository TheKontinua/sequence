...
\centering
    ...
    \caption{Several points for $r = 3\sin{\theta}$ plotted on a Cartesian 
    coordinate system}
    \end{figure}
...
\begin{tikzpicture}
	...
	deg((9*pi)/6), deg((10*pi)/6), deg((11*pi)/6)}, xticklabels={,0,
	$\frac{\pi}{6}$,$\frac{\pi}{3}$,$\frac{\pi}{2}$,$\frac{2\pi}{3}$, 
	$\frac{5\pi}{6}$, ,$\frac{7\pi}{6}$, $\frac{4\pi}{3}$, 
	$\frac{3\pi}{2}$, $\frac{5\pi}{3}$, $\frac{11\pi}{6}$}, ymin = 0, ymax = 1.5, 
	clip = false]
    \draw[gray!30](0,0) -- (180, 1.6);
    \node[black] at (180, 1.65) {$\pi$};
    \end{polaraxis}
    \end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \draw[gray!30](0,0) -- (180, 1.6);
    \node[black] at (180, 1.65) {$\pi$};
    \addplot[blue, thick, domain = 0:180]{cos(x)};
    \end{polaraxis}
    \end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
	...
	clip = false]
    \draw[gray!30](0,0) -- (180, 5);
    \node[black] at (180, 5.05) {$\pi$};
    \end{polaraxis}
    \end{tikzpicture}
\end{Exercise}

...
***REVISE TO INCORPORATE THIS CONCEPT: Intuition behind Gram-Schmidt. Each tie through the loop we subtract off the parts already claimed by the previous members of the new basis. Thus we end up with something perpendicular to all of them. 

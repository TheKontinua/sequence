...
(b) We already have the coordinate point, $(2, 2)$, so to write an equation for the tangent line all we need is the slope. Substituting $x=2 \text{ and }y=2$ into our result from part (a):

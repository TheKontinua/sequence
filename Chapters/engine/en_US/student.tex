...
You can assume that the air/fuel mixture is $80^\circ$ C before the pre-burn compression starts.
...
The temperature is $80 + 273.15 = 353.15^\circ$ K.

The radius of the cylinder is 4.7625cm.

The area of a cross section of the cylinder is $\pi r^2 = \pi (4.7625)^2 \approx 71.26$ cm.

So the change in volume between the minimum and maximum volume is $ (71.26)(10.16) \approx 724$ ml.

(With four cylinders,  the displacement of a Model T is thus 2,896 cc. )
...
$$3.98_v{\text{min}} = v + 724$$

Solving for $v_{\text{min}}$:  $v \approx 243$ ml.

Thus the maximum volume would be $v_{\text{max}} = v_{\text{min}} + 724 = 967$ ml or 0.967 liters.

We are looking for the moles of ethanol; let's call it $n_e$.

By the ideal gas law,  $n$ moles any gas (air or vaporized ethanol) at  $353.15^\circ$ K and 100 kPa has a volume given by:

$$V_e = \frac{n_e r T}{P} = \frac{n_e(8.314)(353.15)}{100} = 29.36 \text{liters}$$ 


So, if we have $n_a$ moles of air and $n_e$ moles of ethanol,  the total volume will fill the maximum volume of the cylinder:
...
$$n_e = \frac{0.006916}{3.21}  = 0.002155 \text{ moles  of ethanol}$$
...
How much heat?  $(0.002155)(1330) =  31.92$ kilojoules.

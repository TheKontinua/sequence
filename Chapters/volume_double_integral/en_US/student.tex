...
$x$ in terms of $y$ (see figure fixme figures of type II regions). That is, a 
type II region can be defined as:
...
\textbf{Solution}: We can define region \textit{D} as $\textit{D} = \{(x, y)
\text{ }|\text{ } -1 \leq x \leq 1, 3x^2 \leq y \leq 2 + x^2 \}$. Therefore, 
